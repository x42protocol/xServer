...
export class CreateComponent implements OnInit, OnDestroy {
  ...
  private lockIfWalletExists(walletName: string) {
    const walletInfo = new WalletInfo(walletName);
    this.lockIfWalletExistsSubscription = this.apiService.getGeneralInfo(walletInfo, true)
      .subscribe(
        response => {
          this.walletLocked = true;
          this.walletExists();
