...
namespace X42.Feature
{
    ...
    /// </summary>
    /// <typeparam name="TImplementation">Type of the registered feature class.</typeparam>
    public class FeatureRegistration<TImplementation> : IFeatureRegistration where TImplementation : class, IServerFeature
    {
        ...
        public void BuildFeature(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection
                ...
                .AddSingleton(typeof(IServerFeature), provider => provider.GetService(this.FeatureType));
        ...
        /// <inheritdoc />
        public IFeatureRegistration DependOn<TFeatureImplementation>() where TFeatureImplementation : class, IServerFeature
        {
