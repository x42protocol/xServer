...
namespace X42.Utilities.Extensions
{
    public static class IPExtensions
    {
        ...
        /// <remarks>
        ///     IP addresses can have a port specified such that the format of <paramref name="ipAddress" /> is as such:
        ///     address:port.
        ///     IPv4 and IPv6 addresses are supported.
        ///     In the case where the default port is passed and the IP address has a port specified in it, the IP address's port
        ...
        /// </summary>
        /// <remarks>
        ///     The method will try to compare a local endpoint to the port of the white-bind endpoint, and if found will return
        ///     the local endpoint that matches.
